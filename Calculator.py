...
micbutton = Button(root, image = microphoneimage, bd = 0, bg = 'dodgerblue3', activebackground = 'dodgerblue3', command = 'audio')
...
for i in button_text_list:
    ...
    button.grid(row = rowvaule, column = columnvalue, pady=1)
    columnvalue += 1
    if columnvalue > 7:
        rowvaule += 1
        columnvalue = 0
